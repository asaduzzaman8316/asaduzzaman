            ...
            return (
                <div className='bg-gray-900 min-h-screen pt-28 pb-16 flex items-center justify-center'>
                    <div className='text-center'>
                        ...
                        <Link href="/#blog" className='text-blue-400 hover:text-blue-300'>Back to all posts</Link>
                    </div>
                </div>
            )
        }
        ...
        return (
            <div className='bg-gray-900 min-h-screen pt-28 pb-16 flex items-center justify-center'>
                <div className='text-center'>
                    ...
                    <p className='text-gray-400 mb-8'>An error occurred while loading the blog post. Please try again later.</p>
                    <Link href="/#blog" className='text-blue-400 hover:text-blue-300'>Back to all posts</Link>
                </div>
            </div>
        )
